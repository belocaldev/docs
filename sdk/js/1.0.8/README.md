...
| translation_style | Values: `auto`, `formal`, `informal`, `technical`, `marketing`, `literary` |
| markup | Values: `html`, `xml`, `custom`. Preserves markup syntax while translating visible text |
